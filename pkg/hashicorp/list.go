...
func ListOrganizations(getClient GetClientFn, t translations.TranslationHelperFunc) (tool mcp.Tool, handler server.ToolHandlerFunc) {
	return mcp.NewTool("list_organizations",
		...
		func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
			...
			if err != nil {
				// It's generally better to return the error for the framework to handle
				return nil, fmt.Errorf("failed to get TFE client: %w", err)
			}

			result, err := client.Organizations.List(ctx, opts)
			if err != nil {
...
func ListProjects(getClient GetClientFn, t translations.TranslationHelperFunc) (tool mcp.Tool, handler server.ToolHandlerFunc) {
	return mcp.NewTool("list_projects",
		...
		func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
			...
			result, err := client.Projects.List(ctx, orgName, opts)
			if err != nil {
...
func ListWorkspaces(getClient GetClientFn, t translations.TranslationHelperFunc) (tool mcp.Tool, handler server.ToolHandlerFunc) {
	return mcp.NewTool("list_workspaces",
		...
		func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
			...
			result, err := client.Workspaces.List(ctx, orgName, opts)
			if err != nil {
